      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <Button variant="outline" onClick={() => handleSocialLogin(signInWithGoogle)}><ChromeIcon className="mr-2 h-4 w-4" /> Google</Button>
            <Button variant="outline" onClick={() => handleSocialLogin(signInWithApple)}><AppleIcon className="mr-2 h-4 w-4" /> Apple</Button>
            <Button variant="outline" onClick={() => handleSocialLogin(signInWithLinkedIn)}><Linkedin className="mr-2 h-4 w-4" /> LinkedIn</Button>
            <Button variant="outline" onClick={() => handleSocialLogin(signInWithTwitter)}><Twitter className="mr-2 h-4 w-4" /> X</Button>
          </div>
        ...
        <CardFooter className="flex flex-col gap-4">
          <Button className="w-full" onClick={() => toast({ title: 'Coming Soon!', description: 'Email/Password login will be implemented soon.' })}>
            Login
          </Button>
